package com.symphony.music.appshortcuts.shortcuttype;
...
import com.symphony.music.appshortcuts.AppShortcutLauncherActivity;

@TargetApi(Build.VERSION_CODES.N_MR1)
public abstract class BaseShortcutType {

    static final String ID_PREFIX = "com.symphony.music.appshortcuts.id.";
